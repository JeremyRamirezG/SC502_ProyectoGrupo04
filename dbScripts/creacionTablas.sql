...
INSERT INTO `tab_citas`(`Fecha`, `Especialidad`, `MétodoReserva`, `Descripción`, `Estado`) VALUES (now(),'Pedicurista','App','Cita para uña encarnada.','Pendiente'),
                                                                                                  (now(),'Cardiología','App','Cita para electrocardiograma.','Pendiente'),
                                                                                                  (now(),'General','App','Cita para revisión anual.','Cancelada');
