...
try{
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(empty($tipo_val)||empty($fecha_val)||empty($resultado_val)||empty($desc_val))
        {
            ...
            echo "<span style='color: #8B0000;font-size: large;padding: 10px;'>$tipo_err<br></span><span style='color: #8B0000;font-size: large;padding: 10px;'>Redireccionando a página principal.</span>";
